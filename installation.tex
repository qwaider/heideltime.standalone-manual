...
Note: When using \product{} with a German, Spanish or Italian language parameter, make sure to get the UTF-8 versions of the TreeTagger parameter files.

Note 2: If you use HeidelTime on Windows, please see Appendix \ref{app:windows}.
\end{enumerate}
